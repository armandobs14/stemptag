...
private final int jjMoveStringLiteralDfa0_0()
{
   ...
   {
      case 34:
         return jjStartNfaWithStates_0(0, 15, 26);
      case 43:
         ...
         MatchLoop: do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 0:
                  ...
                  else if ((0x8000070100002600L & l) != 0L)
                  {
                     if (kind > 6)
                        kind = 6;
                  }
         ...
         MatchLoop: do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 0:
                  ...
                  else if ((0x6800000068000000L & l) != 0L)
                  {
                     if (kind > 6)
                        kind = 6;
                  }
...
"", null, null, null, null, null, null, null, null, null, "\53", "\55", "\72", 
...
public SimpleQueryParserTokenManager(CharStream stream)
{
   input_stream = stream;
}
public SimpleQueryParserTokenManager(CharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
