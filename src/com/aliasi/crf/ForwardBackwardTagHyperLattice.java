...
/**
 * The {@code ForwardBackwardTagHyperLattice} provides an implementation of
 ...
 */
public class ForwardBackwardTagHyperLattice<E> extends TagLattice<E> {
     ...
     */
    public ForwardBackwardTagHyperLattice(List<E> tokens,
                                     List<String> tags,
                                     double[][] logForwards,
                                     double[][] logBackwards,
    ...
    ForwardBackwardTagHyperLattice(List<E> tokens,
                              List<String> tags,
                              double[][] logForwards,
                              double[][] logBackwards,
                              double[][][] logTransitions,
