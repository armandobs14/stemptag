...
public class DemoServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        String demoConstructorArgs = getInitParameter("demoConstructorArgs");
        try {
            mDemo = Constants.constructDemo(demoClass,demoConstructorArgs);
    ...
    private Properties mapToProperties(Map<String,String[]> map) {
        Properties reqProperties = new Properties(mDemo.defaultProperties());
